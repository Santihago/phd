...
# Modified by SMM for research use
...
class Heart_Monitor:
    ...
    def on_beat(self):
        ...
        #result = self.beat_time
        #if result is not None
        #    return self.beat_time is not None
        


    def start(self):
        """Begins the loop of detecting heart beats"""
    ...
    def summary(self):
        ...
        Beats = len(self.RR_intervals)
        BPM = 60000/np.average(self.RR_intervals)
        return (Beats, BPM)
